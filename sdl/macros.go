...
const (
	SDL_MESSAGEBOX_ERROR                 MessageBoxFlags = 0x00000010
	SDL_MESSAGEBOX_WARNING               MessageBoxFlags = 0x00000020
	SDL_MESSAGEBOX_INFORMATION           MessageBoxFlags = 0x00000040
	SDL_MESSAGEBOX_BUTTONS_LEFT_TO_RIGHT MessageBoxFlags = 0x00000080
	SDL_MESSAGEBOX_BUTTONS_RIGHT_TO_LEFT MessageBoxFlags = 0x00000100
)

const (
	SDL_MESSAGEBOX_BUTTON_RETURNKEY_DEFAULT MessageBoxButtonFlags = 0x00000001
	SDL_MESSAGEBOX_BUTTON_ESCAPEKEY_DEFAULT MessageBoxButtonFlags = 0x00000002
)